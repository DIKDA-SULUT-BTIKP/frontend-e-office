...
const SecretaryLayout = ({ children }) => {
  ...
  const menus = [
    { name: "Dasbor", link: "/secretary/dashboard", icon: MdOutlineDashboard },
    {
      name: "Data Surat",
      link: "/secretary/letters",
      icon: BsDatabase,
      submenus: [
        {
          name: "Belum Proses",
          link: "/secretary/letters/not-process",
          icon: BsDatabaseDash,
        },
        {
          name: "Diproses",
          link: "/secretary/letters/process",
          icon: BsDatabase,
        },
        {
          name: "Selesai Proses",
          link: "/secretary/letters/completed",
          icon: BsDatabaseCheck,
        },
        {
          name: "Disposisi",
          link: "/secretary/letters/dispositioned",
          icon: BsDatabaseCheck,
        },
      ],
    },
