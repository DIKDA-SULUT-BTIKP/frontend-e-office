...
const DivisionLayout = ({ children }) => {
  ...
  const menus = [
    { name: "Dasbor", link: "/division/dashboard", icon: MdOutlineDashboard },
    {
      name: "Data Surat",
      link: "/division/letters",
      icon: BsDatabase,
      submenus: [
        {
          name: "Belum Proses",
          link: "/division/letters/not-process",
          icon: BsDatabaseDash,
        },
        {
          name: "proses",
          link: "/division/letters/in-process",
          icon: BsDatabase,
        },
        {
          name: "Selesai Proses",
          link: "/division/letters/completed",
