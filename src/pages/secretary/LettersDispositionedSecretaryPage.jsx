...
const LettersDispositionedSecretaryPage = () => {
  ...
  const fetchLetters = async () => {
    try {
      const response = await axios.get(
        `http://localhost:5000/letters/dispositioned/secretary?search_query=${keyword}&page=${page}&limit=${limit}`
      );
...
export default LettersDispositionedSecretaryPage;
